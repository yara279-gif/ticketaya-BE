...
class Post_comment (models.Model):
    ...
    author_id   =  models.ForeignKey(User, related_name="author_comment", on_delete=models.CASCADE)
    author_name =  models.CharField(max_length=255)
    created_at  =  models.DateTimeField(auto_now_add=True)  
    update_at   =  models.DateTimeField(auto_now=True)
    likes       =  models.ManyToManyField(User, related_name="commens_likes", blank=True , default=False)
